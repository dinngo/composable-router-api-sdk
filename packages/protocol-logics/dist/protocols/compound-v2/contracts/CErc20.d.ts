...
export interface CErc20Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'liquidateBorrow', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
...
export interface CErc20 extends BaseContract {
    ...
    functions: {
        ...
        repayBorrow(repayAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        liquidateBorrow(borrower: PromiseOrValue<string>, repayAmount: PromiseOrValue<BigNumberish>, cTokenCollateral: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        interestRateModel(overrides?: CallOverrides): Promise<string>;
        liquidateBorrow(borrower: PromiseOrValue<string>, repayAmount: PromiseOrValue<BigNumberish>, cTokenCollateral: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        admin(overrides?: CallOverrides): Promise<string>;
        borrowRatePerBlock(overrides?: CallOverrides): Promise<BigNumber>;
