...
export interface Permit2Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'transferFrom(address,address,uint160,address)', values: [PromiseOrValue<string>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
