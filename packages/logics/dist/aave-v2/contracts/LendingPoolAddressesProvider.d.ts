...
export interface LendingPoolAddressesProvider extends BaseContract {
    ...
    functions: {
        ...
        setAddressAsProxy(id: PromiseOrValue<BytesLike>, implementationAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setEmergencyAdmin(emergencyAdmin: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setAddressAsProxy(id: PromiseOrValue<BytesLike>, implementationAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
