...
export declare namespace ISwapRouter {
    ...
    type ExactInputParamsStructOutput = [string, string, BigNumber, BigNumber, BigNumber] & {
        path: string;
        recipient: string;
        deadline: BigNumber;
        amountIn: BigNumber;
    ...
    type ExactOutputParamsStructOutput = [string, string, BigNumber, BigNumber, BigNumber] & {
        path: string;
        recipient: string;
        deadline: BigNumber;
        amountOut: BigNumber;
...
export interface SwapRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: 'sweepToken', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: 'unwrapWETH9WithFee', values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>, PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
